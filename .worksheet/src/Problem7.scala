object Problem7 {import scala.runtime.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(482); 
  /*
...
What is the 10001st prime number?
  ...
  };System.out.println("""isPrime: (n: Long)Boolean""");$skip(13); val res$0 = 
  ...
  isPrime(13195);System.out.println("""res6: Boolean = """ + $show(res$6));$skip(240); 
  ...
  };System.out.println("""getPrimeNr: (e: Long)Long""");$skip(19); val res$7 = 
  ...
  getPrimeNr(1000);System.out.println("""res18: Long = """ + $show(res$18));$skip(20); val res$19 = 
  getPrimeNr(10001);System.out.println("""res19: Long = """ + $show(res$19))}
}
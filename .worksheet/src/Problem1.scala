object Problem1 {import scala.runtime.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(391); 
    /*
...
Find the sum of all the multiples of 3 or 5 below 1000.
    */
    ...
    solveFunc(1000);System.out.println("""res9: Int = """ + $show(res$9));$skip(104); val res$10 = 

object Problem006 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(540); 
    /*
...
Find the difference between the sum of the squares of the first one hundred natural numbers and the square of the sum.
    */
    ...
    solution3((1 to 10).toList);System.out.println("""res15: Int = """ + $show(res$15));$skip(61); val res$16 = 

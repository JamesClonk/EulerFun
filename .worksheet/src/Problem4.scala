object Problem4 {import scala.runtime.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(352); 
    /*
...
Find the largest palindrome made from the product of two 3-digit numbers.
    */
    ...
    def isPalindromic(n: Long): Boolean =
        n.toString == n.toString.reverse;System.out.println("""isPalindromic: (n: Long)Boolean""");$skip(32); val res$0 = 
    ...
    isPalindromic(9019);System.out.println("""res3: Boolean = """ + $show(res$3));$skip(148); val res$4 = 

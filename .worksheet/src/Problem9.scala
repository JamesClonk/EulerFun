object Problem9 {import scala.runtime.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(410); 
    /*
...
Find the product abc.
   */
    ...
    def isPythagoreanTriplet(a: Int, b: Int, c: Int): Boolean =
        (a < b && b < c && a * a + b * b == c * c);System.out.println("""isPythagoreanTriplet: (a: Int, b: Int, c: Int)Boolean""");$skip(335); 
    ...
    def findSolution(x: Int): Int = {
        ...
        -1
    };System.out.println("""findSolution: (x: Int)Int""");$skip(29); val res$0 = 
    
    findSolution(1+4+9);System.out.println("""res0: Int = """ + $show(res$0));$skip(26); val res$1 = 
    findSolution(9+16+25);System.out.println("""res1: Int = """ + $show(res$1));$skip(23); val res$2 = 

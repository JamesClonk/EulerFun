object Problem5 {import scala.runtime.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(340); 
    /*
...
What is the smallest positive number that is evenly divisible by all of the numbers from 1 to 20?
    */
	...
	def divisibleBy(n: Int, xs: List[Int]): Boolean =
		xs.forall(n % _ == 0);System.out.println("""divisibleBy: (n: Int, xs: List[Int])Boolean""");$skip(38); val res$0 = 
	
	divisibleBy(100, (1 to 10).toList);System.out.println("""res0: Boolean = """ + $show(res$0));$skip(37); val res$1 = 
	divisibleBy(2520, (1 to 10).toList);System.out.println("""res1: Boolean = """ + $show(res$1));$skip(232); 
	...
	};System.out.println("""findDivisibleBy: (xs: List[Int])Int""");$skip(36); val res$2 = 
	...
	findDivisibleBy((1 to 15).toList);System.out.println("""res4: Int = """ + $show(res$4));$skip(35); val res$5 = 
